...
namespace Hospital_Web.Controllers
{
    public class ConsultasController : Controller
    {
        ...
        {
            ViewData["Gabinete_Id"] = new SelectList(_context.Set<Gabinete>(), "ID", "Bloco");
            ViewData["Medico_Id"] = new SelectList(_context.Set<Medico>(), "N_Processo", "Nome");
        ...
        public async Task<IActionResult> Create([Bind("Episodio,Data,Hora,Diagnostico,Tratamento,Observacoes,Medico_Id,Utente_Id,Gabinete_Id")] Consulta consulta)
        {
            ...
            ViewData["Gabinete_Id"] = new SelectList(_context.Set<Gabinete>(), "ID", "Bloco", consulta.Gabinete_Id);
            ViewData["Medico_Id"] = new SelectList(_context.Set<Medico>(), "N_Processo", "Nome", consulta.Medico_Id);
            ViewData["Utente_Id"] = new SelectList(_context.Set<Utente>(), "N_Processo", "Nome", consulta.Utente_Id);
            return View(consulta);
        }
