...
namespace Hospital_Web.Controllers
{
    public class GabinetesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("N_Identificador,Descricao,Equipamento,Disponivel")] Gabinete gabinete)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("N_Identificador,Descricao,Equipamento,Disponivel")] Gabinete gabinete)
        {
            if (id != gabinete.N_Identificador)
            {
                return NotFound();
            }
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    if (!GabineteExists(gabinete.N_Identificador))
                    {
                        return NotFound();
                    }
                    else
        ...
        {
            return _context.Gabinete.Any(e => e.N_Identificador == id);
        }
    }
}
